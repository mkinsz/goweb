...
type Server struct {
	...
	RunMode      string        `json:"RunMode"`      // Gin Run Mode
	ReadTimeout  time.Duration `json:"ReadTimeout"`  // Read timeout
	WriteTimeout time.Duration `json:"WriteTimeout"` // Write timeout
